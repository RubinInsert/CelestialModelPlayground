...
setInterval(() => {
  ...
  if (currentElement) {
    const isEnabled = currentElement.spinStateVisualizationEnabled || false;
    currentElement.setSpinStateVisualization(!isEnabled);
    document.getElementById("enable-spin-state").checked = !isEnabled;
  }
}, 15000);
function animate() {
